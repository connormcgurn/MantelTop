...
#pic_hover:hover {
 ...
 such as $30, $40, and even $50 a picture, Mantel Top Photography offers professional digital purchases for just $10 a picture.</p>
  <div align="center">
  <br>
 <a href="/browseRaces" class="btn btn-lg btn-primary">Browse Races</a>
  </div>
 <div class="container">
  <div class="row">
	<img id="pic_hover" src="assets/images/sport1.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport2.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport3.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport4.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport5.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport6.jpg" width="140px" height="140" alt="..." class="img-rounded">
  <img id="pic_hover" src="assets/images/sport7.jpg" width="140px" height="140" alt="..." class="img-rounded">
  </div>
</div>
